...
def main(args):
    ...
    if(args.karyotype):
        ...
        for line in K:
            ...
            for chro in chros:
                ...
                if len(items)==3:
                    ...
                    name_count[name] += 1
                    real_name = name
                    name = '{}_{}'.format(name, name_count[name]) if (name_count[name] > 0) else name
        ...
        while 1 :
            ...
            chro1s = [x for x in all_names if x.startswith(chro1)]
            chro2s = [x for x in all_names if x.startswith(chro2)]
